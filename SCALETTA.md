...
**Avanzamento: 14 / 71** — ultimo completato: **0.10** · corrente: **0.11**
...
- [x] **0.10** 🟢 `.vscode/extensions.json`: SonarQube, ESLint, Python; rimosso `Vue.volar` — *aprendo la cartella, VSCode propone le tre estensioni giuste*
